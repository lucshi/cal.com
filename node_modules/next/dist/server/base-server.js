...
class Server {
    ...
    async handleRequest(req, res, parsedUrl) {
        ...
        console.log("Server::handleRequest: start, ","req.id: ", req.id, "start time: ", startTime);  // Log before the operation starts
        console.log('Server::handleRequest: Request: ', req.id);
        console.log('Server::handleRequest: Request Method:', req.method);
        console.log('Server::handleRequest: Request URL:', req.url);
        // console.log('Server::handleRequest: Request Headers:', req.headers);
        const result = await (0, _tracer).getTracer().trace(_constants1.BaseServerSpan.handleRequest, async ()=> {
            console.log("Server::handleRequest: inside trace function start");  // Log before the inner function starts
            const innerResult = await this.handleRequestImpl(req, res, parsedUrl);
            console.log("Server::handleRequest: inside trace function end");  // Log after the inner function ends
            console.log("Server::handleRequest: Response Status Code:", res.statusCode);
            // console.log("Server::handleRequest: Response Headers:", res);
            return innerResult;
        });
        // console.log("Server::handleRequest: end");  // Log after the operation ends
        // console.log("Server::handleRequest: Result:", result);  // Log the result
        const endTime = process.hrtime();
        console.log("Server::handleRequest: end, ","req.id: ", req.id, "endTime: ", endTime);
        return result;
    }    
