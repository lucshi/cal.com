...
class NextNodeServer extends _baseServer.default {
     ...
     */ if (this.renderOpts.optimizeFonts) {
        ...
        if (!options.dev && this.nextConfig.experimental.instrumentationHook) {
            try {
                const instrumentationHook = require((0, _path).join(options.dir || ".", options.conf.distDir, "server", _constants1.INSTRUMENTATION_HOOK_FILENAME));
        ...
        // chenyu add
        process.on('SIGINT', () => {
            console.log('Received SIGINT signal. Waiting 3 seconds before closing server...');
            setTimeout(() => {
    ...
    getRoutes() {
        ...
        if (this.hasAppDir) {
            routes.handlers.set(_routeKind.RouteKind.APP_ROUTE, new _appRouteRouteHandler.AppRouteRouteHandler());
        }
        return routes;
    }
    ...
    async findPageComponents({ pathname , query , params , isAppPath  }) {
        return (0, _tracer).getTracer().trace(_constants2.NextNodeServerSpan.findPageComponents, ()=>this.findPageComponentsImpl({
                pathname,
                query,
                params,
                isAppPath
    ...
    generateRoutes() {
        ...
        const catchAllRoute = {
            ...
            fn: async (req, res, _params, parsedUrl)=>{
                ...
                if ((ref1 = options.i18n) == null ? void 0 : ref1.detectedLocale) {
   ...
   */ async runMiddleware(params) {
        ...
        let url;
        const options = {
            i18n: (ref = this.localeNormalizer) == null ? void 0 : ref.match(normalizedPathname)
        };
        ...
        if (!result) {
            ...
            for (let [key, value] of allHeaders){
                ...
                if (key.toLowerCase() === "set-cookie") {
                    (0, _requestMeta).addRequestMeta(params.request, "_nextMiddlewareCookie", (0, _utils1).splitCookiesString(value));
                }
            }
        }
        return result;
    ...
    attachRequestMeta(req, parsedUrl) {
        var ref, ref2;
        const protocol = ((ref2 = (ref = req.originalRequest) == null ? void 0 : ref.socket) == null ? void 0 : ref2.encrypted) ? "https" : "http";
